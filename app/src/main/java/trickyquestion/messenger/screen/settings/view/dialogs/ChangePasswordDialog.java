package trickyquestion.messenger.screen.settings.view.dialogs;
...
public class ChangePasswordDialog extends DialogFragment implements IChangeDialog {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder
                ...
                .setView(container)
                .setIcon(getDrawable(R.drawable.ic_change_pass_primary_green))
    ...
    private SpannableString getCustomizeTitle(@NonNull final String title) {
