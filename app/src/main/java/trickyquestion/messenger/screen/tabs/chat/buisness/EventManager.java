...
import trickyquestion.messenger.screen.tabs.chat.ui.ChatPresenter;
import trickyquestion.messenger.screen.tabs.chat.ui.IChatPresenter;
...
public class EventManager extends BaseEventManager {
    ...
    public EventManager(IChatPresenter presenter) {
