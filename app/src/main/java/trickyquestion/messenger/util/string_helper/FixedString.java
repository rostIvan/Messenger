...
public final class FixedString {
    @NotNull
    static public java.lang.String fill(java.lang.String val, char filler, int sz){
    ...
    static public java.lang.String toDynamicSize(java.lang.String val, char filler){
